...
namespace Siemens.Opc.Da
{
    ...
    public class Server: IDisposable
    {
        ...
        public Subscription CreateSubscription(string groupName, int RequestedUpdateRate, DataChange callback)
        {
            if (!m_connected)
            {
                throw new InvalidOperationException("Not connected to OPC-Server!");
            ...
            subscription.Create(groupName, RequestedUpdateRate, callback);
            return subscription;
        }
